...
import {
  ArrowLeft, ShoppingBag, Search, ArrowUpRight,
  Plus,
  Instagram,
  User,
  Heart,
          ...
          {s.products.map((p: any, i: number) => (
            <div key={i} className="group cursor-pointer">
              <div className="relative aspect-[3/4] bg-white/[0.03] rounded-[2rem] overflow-hidden border border-white/5 mb-6">
                <img src={p.image} className="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-110 transition-all duration-1000" alt={p.name}  loading="lazy" decoding="async"/>
          ...
          <div className="grid grid-cols-4 gap-4">
            {s.varients.map((p: any, i: number) => (
              <div key={i} className="aspect-square bg-gray-50 rounded-lg overflow-hidden cursor-pointer hover:ring-1 ring-black transition-all">
                <img src={p.image} className="w-full h-full object-cover" alt={`thumb-${i}`}  loading="lazy" decoding="async"/>
              </div>
            ))}
          ...
          {s.products.map((p: any, i: number) => (
            <div key={i} className="group cursor-pointer">
              <div className="aspect-[3/4] bg-white overflow-hidden rounded-xl mb-4 relative">
                <img src={p.image} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" alt={p.name}  loading="lazy" decoding="async"/>
          ...
          <div className="col-span-6 flex justify-center items-center gap-8 whitespace-nowrap">
            {[
              ...
              <div key={item.name} className="relative group cursor-pointer py-2">
                <span className={`text-[11px] font-bold uppercase tracking-[0.25em] transition-colors duration-300 ${item.active ? 'text-[#c4a484]' : 'text-zinc-500 group-hover:text-black'
                  }`}>
                  {item.name}
                </span>
                {item.active && (
            ...
            <div className="relative w-[550px] h-[650px]">
              ...
              <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,0,0,0.2)] z-10">
                <img
                  ...
                  className="w-full h-full object-cover transform scale-105 hover:scale-110 transition-transform duration-[length:3000ms]"
                  alt="Elite Jewelry"
                />
              </div>
            </div>
    ...
    <div className="bg-white text-[#1a1a1a] font-sans selection:bg-[#e2dfd5] selection:text-black">
          ...
          {[1, 2].map((i) => (
            <div key={i} className="space-y-8 group cursor-pointer">
              <div className="aspect-video overflow-hidden">
                <img src={i === 1 ? "/saha-garden-product6-shopify-store.webp" : "/saha-garden-blog-shopify-store.webp"} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-[length:2000ms]" alt="Blog" />
              </div>
      ...
      <footer className="bg-white border-t border-gray-100 pt-20 pb-10 px-10 text-center">
        <div className="text-[9px] text-gray-400 uppercase tracking-[0.5em] font-bold">
          © 2026 SAHA GARDEN STUDIO — BUILT BY RANKVELT
        </div>
      </footer>
    </div>
  );
    ...
    <div className="bg-white text-black font-sans selection:bg-gray-200">
          ...
          {s.products.map((p: any, i: number) => (
            <div key={i} className="group cursor-pointer">
              <div className="aspect-[4/5] bg-[#f5f5f5] mb-4 relative overflow-hidden">
                <img src={p.image} className="w-full h-full object-cover group-hover:scale-105 transition-all duration-700" alt={p.name}  loading="lazy" decoding="async"/>
              </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-1 mb-20">
        {[
          ...
          >
            ...
            <img
              src={item.img}
              className="w-full h-full object-cover group-hover:scale-110 transition-all duration-[length:2s] ease-out"
              alt={item.alt}
            />
      ...
      <footer className="bg-gray-100 pt-20 pb-10 px-10">
        ...
        <div className="flex justify-between items-center pt-10 border-t border-black/5 text-[9px] font-bold uppercase tracking-[0.3em] opacity-40">
          ...
          <span>© 2026 KITH NYC — BUILT BY RANKVELT</span>
  ...
  return (
    <div className="w-full rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl">
      ...
      <div className="bg-white/5 px-6 py-3 border-b border-white/5 flex justify-between items-center text-[10px] opacity-40">
        ...
        <span className="uppercase tracking-widest font-mono">rankvelt.preview/{project.id}</span>
...
if (!projectId) {
  return (
    <main className="min-h-screen bg-[#050505] px-6 pb-24 pt-40 text-white">
      <div className="mx-auto max-w-[1400px]">
        <section className="max-w-4xl">
          <span className="mb-4 block text-xs font-black uppercase tracking-[0.35em] text-[#f9a825]">
            RankVelt Portfolio
          </span>

          <h1 className="text-5xl font-black uppercase leading-[0.88] tracking-tighter sm:text-6xl md:text-8xl">
            Case{" "}
          ...
          <p className="mt-7 max-w-2xl text-base leading-relaxed text-white/75 sm:text-lg">
            Search growth, technical SEO, Shopify design, and ecommerce
            projects built around better visibility, stronger user journeys,
        ...
        <nav
          ...
          className="mt-12 flex flex-wrap gap-x-6 gap-y-3 border-y border-white/10 py-4"
        >
          <a
            href="#seo-projects"
            className="text-[11px] font-black uppercase tracking-[0.18em] text-white/75 transition-colors hover:text-[#f9a825]"
          >
            SEO Case Studies
          </a>
        ...
        {/* SEO CASE STUDIES — TOP */}
        <section
          id="seo-projects"
          className="scroll-mt-28 mt-20 border-t border-white/10 pt-12"
        >
          <div className="flex flex-col gap-4 border-b border-white/10 pb-8 md:flex-row md:items-end md:justify-between">
            <div>
              <span className="text-[10px] font-black uppercase tracking-[0.28em] text-[#f9a825]">
                SEO Growth & Technical Performance
              </span>
            ...
            <p className="max-w-md text-sm leading-relaxed text-white/70">
              Search performance case studies supported by Google Search
              Console data and, where available, Google PageSpeed Insights
              audit evidence.
            </p>
          </div>
          ...
          <div className="mt-10 grid gap-7 md:grid-cols-2 lg:grid-cols-3">
            {seoCaseStudies.map((study) => (
              <Link
                key={study.path}
                to={study.path}
                className="group rounded-[1.75rem] border border-white/[0.08] bg-white/[0.035] p-3 transition-all duration-300 hover:-translate-y-1 hover:border-[#f9a825]/50 hover:bg-white/[0.06]"
              >
                <div className="relative overflow-hidden rounded-[1.2rem] border border-white/[0.08] bg-black">
                  <img
                    src={study.image}
                    alt={`${study.title} SEO performance case study`}
                    className="aspect-video w-full object-cover object-top transition duration-500 group-hover:scale-105"
                    loading="lazy"
                    decoding="async"
                  />

                  <span className="absolute left-3 top-3 rounded-full border border-[#f9a825]/30 bg-black/70 px-3 py-1.5 text-[9px] font-black uppercase tracking-[0.14em] text-[#ffe066] backdrop-blur-sm">
                    SEO Performance
                  </span>
                </div>
                ...
                <div className="px-2 pb-2 pt-5">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <p className="mt-2 text-[10px] font-black uppercase tracking-[0.16em] text-[#f9a825]">
                        {study.category}
                      </p>
                    </div>
                    ...
                    <ArrowUpRight
                      size={19}
                      className="mt-1 shrink-0 text-white/45 transition-all duration-300 group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-[#f9a825]"
                    />
                  </div>
                  ...
                  <span className="mt-5 inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.17em] text-white/80 transition-colors group-hover:text-[#f9a825]">
                    Read SEO Case Study
                    <ArrowRight size={14} />
                  </span>
                </div>
        ...
        {/* SHOPIFY CASE STUDIES — BOTTOM */}
        <section
          id="shopify-projects"
          className="scroll-mt-28 mt-24 border-t border-white/10 pt-12"
        >
          <div className="flex flex-col gap-4 border-b border-white/10 pb-8 md:flex-row md:items-end md:justify-between">
            <div>
              <span className="text-[10px] font-black uppercase tracking-[0.28em] text-[#f9a825]">
            ...
            <p className="max-w-md text-sm leading-relaxed text-white/70">
              Custom Shopify store concepts focused on product discovery,
              conversion clarity, visual identity, trust signals, and mobile
              shopping experience.
            </p>
          </div>
            ...
            {caseStudies.map((project) => (
              ...
              >
                <div className="relative overflow-hidden rounded-[1.2rem]">
                  <img
                    src={project.image}
                    alt={`${project.title} Shopify store design project`}
                    className="aspect-video w-full object-cover grayscale transition duration-500 group-hover:scale-105 group-hover:grayscale-0"
                    loading="lazy"
                    decoding="async"
                  />

                  <span className="absolute left-3 top-3 rounded-full border border-black/20 bg-black/60 px-3 py-1.5 text-[9px] font-black uppercase tracking-[0.14em] text-white backdrop-blur-sm">
                    Shopify Project
                  </span>
                </div>
        ...
        <section className="mt-24 border-t border-white/10 pt-10">
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              <span className="text-[10px] font-black uppercase tracking-[0.25em] text-[#f9a825]">
                RankVelt Services
              </span>

              <h2 className="mt-3 text-3xl font-black uppercase tracking-tight text-white">
                Need Better SEO or a Stronger Shopify Store?
              </h2>

              <p className="mt-4 text-sm leading-relaxed text-white/70">
                RankVelt combines SEO strategy, technical improvements,
                ecommerce UX, Shopify development, and conversion-focused
                structure to help businesses grow with more clarity.
              </p>
            </div>

            <Link
              to="/strategy-call?package=SEO%20and%20Ecommerce%20Opportunity%20Check"
              className="inline-flex w-fit items-center gap-2 rounded-lg bg-[#f9a825] px-5 py-3.5 text-[10px] font-black uppercase tracking-[0.16em] text-black transition-transform hover:scale-[1.02]"
            >
      ...
      <div className="max-w-[1500px] mx-auto">
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            <span className="text-[#f9a825] text-[12px] font-black uppercase tracking-[0.4em] mb-6 block">
              {project.category}
            </span>
